        ...
        <div className="footer__content">
          <div className="footer__section">
            ...
            <p className="footer__description">
              Experience luxury and comfort at the finest hotels worldwide. Your
              perfect stay is just a booking away.
            </p>
          ...
          <div className="footer__section">
            ...
            <div className="footer__links">
              ...
              <Link to="/hotels" className="footer__link">
                Hotels
              </Link>
          ...
          <div className="footer__section">
            ...
            <div className="footer__links">
              ...
              <Link to="/cancellation" className="footer__link">
                Cancellation Policy
              </Link>
            </div>
          </div>
